...
const HomeScreen = () => {
  ...
  return (
    <main className="relative w-screen h-screen overflow-x-hidden overflow-y-scroll  snap-y snap-mandatory bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900">
      {/* <main className="relative w-screen h-screen overflow-x-hidden bg-[#1b1c53] overflow-y-scroll snap-y snap-mandatory bg-gradient-to-tr from-sky-700 to-sky-900"> */}
