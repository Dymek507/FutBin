...
const FirstViewPortrait = forwardRef<HTMLInputElement, IFirstViewProps>(({ scrollTo }, ref) => {
  ...
  return (
    <section ref={ref} className='relative h-screen text-xl xs:text-2xl bg-no-repeat snap-center flex bg-[#000C15] text-white'>
      ...
      <BackgroundWater />
      {/* Main content */}
      <main className="absolute inset-0 flex flex-col items-center w-full mt-16 overflow-x-hidden">
        {/* Text */}
        <motion.p className="text-[3.5em] font-semibold leading-none z-[0]" {...slideAnimationY("bottom", 0.5, 0, "200%")}>Fut Draft</motion.p>
